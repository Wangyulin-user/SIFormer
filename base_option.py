...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='img', help='name of the experiment. It decides where to store samples and models')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='SIformer', help='selects model to use for netG (pix2pixhd | spade)')
